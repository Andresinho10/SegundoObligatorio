                    ...
                    switch (opcion)
                    {
                        ...
                        case "3":
                           	...
                           	
                            {
                            	...
                            	Debito b=Cliente.TarjetaDebito(opcionOperacion);
                            	Console.Write("\n\tDigite el saldo que desea cargar:");
                            	int monto=Convert.ToInt32(Console.ReadLine());
                                b.CargarSaldo(monto,b);
                                Console.Write("Saldo cargado con exito");
                        ...
                        case "4":
                            ...
                            switch (opcion)
                            {
                                ...
                                case "3":
                                    ...
                                    if(Cliente.BuscarTarjeta(numTarjeta))
                                    {
                                      ...
                                      else if (!Cliente.BuscarTarjeta(numTarjeta))
	                                        {
	                                          Console.WriteLine("\n\tEl numero ingresado no corresponde con una tarjeta de credito o no está registrado en el sistema.");
	                                        }
